...
implicit none
real(rk),intent(inout) :: X(3),CA(3),SA(3)
...
implicit none
real(rk),intent(inout) :: XY(3),X(3),Y(3)
...
implicit none
real(rk),intent(inout) :: XY,X(3),Y(3)
